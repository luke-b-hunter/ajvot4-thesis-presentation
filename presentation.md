...
The website includes the movement's logo in the main bar, along with other buttons where users can find more detailed information about the movement's events and program. There would also be an action map button in the toolbar, where users would see a detailed map of previous and upcoming events. Photos from the event would serve as a strong visual element so that the public can clearly see what characterizes the movement. The intention is to show that the movement is here for the public and is not a corporation. Below the photos, a description of the movement would be displayed so that users could understand what type of movement the movement it is. They could find more detailed information about the movement on the website, along with a program and other photos from the event as well.
